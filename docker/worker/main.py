...
async def startup(ctx):
    """Connect to Qdrant, pre-warm embedding models, and validate collection."""
    ...
    # Pre-warm FastEmbed BM25 sparse model (non-blocking, fail-safe)
    try:
        ...
        logger.info("BM25 sparse model pre-warmed")
    except Exception:
        logger.warning("BM25 pre-warm skipped (will download on first ingestion)")
