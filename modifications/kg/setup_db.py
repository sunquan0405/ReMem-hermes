...
-- Entity relations — directed edges with temporal validity
CREATE TABLE IF NOT EXISTS entity_relations (
    relation_id   INTEGER PRIMARY KEY AUTOINCREMENT,
    subject_id    INTEGER NOT NULL REFERENCES entities(entity_id),
    relation      TEXT NOT NULL,       -- 'uses' | 'depends_on' | 'replaces' | 'part_of' | 'mentioned_in'
...
CREATE INDEX IF NOT EXISTS idx_er_subject ON entity_relations(subject_id);
CREATE INDEX IF NOT EXISTS idx_er_object  ON entity_relations(object_id);
CREATE INDEX IF NOT EXISTS idx_er_relation ON entity_relations(relation);
"""
